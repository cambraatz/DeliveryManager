...
const PopupContent_DeliveryList = (props) => {
    ...
    return(
        ...
        {loading || !dl || dl.length === 0 ? (
            ...
            <div className='popupDeliveryList content'>{/*<div id="popupPrompt" className="content">
                ...
                <div className="table_div dl_table_div">
                    ...
                    <div className="scrollable_tbody">
                        <table className="Delivery_Table cb_table">
                            ...
                            {dl.map((delivery,i) => {
                                return (
                                    <tr id={`dl_${i}`} key={`dl_${i}`} className="Table_Body">
                ...
                <div id="dl_button_div">
                    <button id="dl_cancel_button" className="dl_popup_button" onClick={props.onClose}>Cancel</button>
                    <button id="dl_proceed_button" className="dl_popup_button" onClick={() => props.onClick(selected)}>Proceed</button>
                </div>
            </div>
        )}
        </>
...
export default PopupContent_DeliveryList;

PopupContent_DeliveryList.propTypes = {
